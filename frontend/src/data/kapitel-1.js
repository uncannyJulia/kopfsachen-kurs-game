...
export const KAPITEL_1_NODES = [
  ...
  { nodeId: 4, speaker: 'evu', text: 'Manches wird dir vielleicht bekannt vorkommen, mit anderem kannst du dich weniger identifizieren. Versuche, dich auf Tonis Welt einzulassen.', emotion: 'happy', nextNodeId: null, choices: [
    { text: 'Los geht\'s', nextNodeId: 10 },
  ]},

  // ══════════════════════════════════════════════════════
  // Phase 2: ERLEBEN — Toni vor dem Fitnessstudio
  // ══════════════════════════════════════════════════════
  { nodeId: 10, speaker: 'narrator', text: 'Toni steht vor einem Fitnessstudio. Schaut unruhig aus. Wartet.', emotion: null, nextNodeId: 11 },
  { nodeId: 11, speaker: 'toni', text: 'Ich warte jetzt schon 10 Minuten auf Neo.', emotion: 'worried', nextNodeId: 12 },
  { nodeId: 12, speaker: 'user', text: '', nextNodeId: null, choices: [
    { text: 'Hat Neo vielleicht etwas geschrieben?', nextNodeId: 13 },
  ]},
  { nodeId: 13, speaker: 'narrator', text: 'Toni schaut aufs Handy.', emotion: null, nextNodeId: 14 },
  { nodeId: 14, speaker: 'toni', text: 'Keine Nachricht von Neo.', emotion: 'sad', nextNodeId: 15 },
  { nodeId: 15, speaker: 'toni', text: 'Wir wollten doch zusammen zu diesem Sportkurs.', emotion: 'sad', nextNodeId: 16 },
  { nodeId: 16, speaker: 'toni', text: 'Soll ich da alleine hingehen?', emotion: 'worried', nextNodeId: null, choices: [
    { text: 'Lieber nicht.',        nextNodeId: 17 },
    { text: 'Ja komm, das passt schon.', nextNodeId: 18 },
  ]},
  { nodeId: 17, speaker: 'toni', text: 'Ich war da auch noch nie und ich kenne da niemanden.', emotion: 'worried', nextNodeId: 19 },
  { nodeId: 18, speaker: 'toni', text: 'Ich war da aber noch nie und ich kenne da niemanden.', emotion: 'worried', nextNodeId: 19 },
  { nodeId: 19, speaker: 'narrator', text: 'Toni schaut nochmal aufs Handy.', emotion: null, nextNodeId: 20 },
  { nodeId: 20, speaker: 'toni', text: 'Ich habe echt keine Lust, das jetzt alleine zu machen. Das ist mir zu stressig.', emotion: 'sad', nextNodeId: 21 },
  { nodeId: 21, speaker: 'toni', text: 'Wieso meldet sich Neo nicht?!', emotion: 'sad', nextNodeId: null, choices: [
    { text: 'Okay, erstmal kurz entspannen.', nextNodeId: 25 },
    { text: 'Komm schon. Reiß dich zusammen!', nextNodeId: 22 },
  ]},
  { nodeId: 22, speaker: 'toni', text: 'Ich merke richtig Druck in der Brust.', emotion: 'worried', nextNodeId: null, choices: [
    { text: 'Vielleicht helfen ein paar tiefe Atemzüge.',     nextNodeId: 25 },
    { text: 'Das ist alles Neos Schuld.',                     nextNodeId: 23 },
  ]},
  { nodeId: 23, speaker: 'toni', text: 'Ich glaub, ich sollte mal kurz entspannt durchatmen.', emotion: 'thinking', nextNodeId: 25 },
  ...
  { nodeId: 26, speaker: 'toni', text: 'Okay, jetzt fühl ich mich ein bisschen klarer.', emotion: 'calm', nextNodeId: 27 },
  ...
  { nodeId: 28, speaker: 'toni', text: 'Ich glaube, Neo wird nicht mehr kommen — und der Kurs hat jetzt sowieso schon angefangen.', emotion: 'sad', nextNodeId: 30 },
  { nodeId: 29, speaker: 'toni', text: 'Mist, der Kurs hat jetzt schon angefangen.', emotion: 'sad', nextNodeId: 30 },
  { nodeId: 30, speaker: 'toni', text: 'Manu wohnt doch gleich hier um die Ecke.', emotion: 'thinking', nextNodeId: null, choices: [
    { text: 'Zu Manu gehen', nextNodeId: 35 },
  ]},

  // ── Bei Manu ──────────────────────────────────────────
  { nodeId: 35, speaker: 'manu', text: 'Sehr ärgerlich und merkwürdig. Neo ist doch eigentlich zuverlässig.', emotion: 'worried', nextNodeId: null, choices: [
    { text: 'Ich verstehe es auch nicht.', nextNodeId: 36 },
    { text: 'Richtig nervig.',             nextNodeId: 36 },
  ]},
  { nodeId: 36, speaker: 'toni', text: 'Neo hat sich einfach nicht gemeldet. Ich wollte nicht alleine gehen und schließlich war es auch zu spät.', emotion: 'sad', nextNodeId: 37 },
  { nodeId: 37, speaker: 'manu', text: 'Das hört sich stressig an.', emotion: 'calm', nextNodeId: 38 },
  { nodeId: 38, speaker: 'toni', text: 'Ich hab dann irgendwann tief durchgeatmet. Das hat mich etwas entspannt. Dann fiel mir ein, dass du hier in der Nähe wohnst.', emotion: 'calm', nextNodeId: 39 },
  { nodeId: 39, speaker: 'manu', text: 'Ja, ruhiges und tiefes Atmen kann bei stressigen Situationen richtig hilfreich sein, um etwas runterzukommen.', emotion: 'happy', nextNodeId: 40 },
  ...
  { nodeId: 49, speaker: 'toni', text: 'Ja, vielleicht hast du Recht.', emotion: 'thinking', nextNodeId: 50 },

  // ── Nachricht von Neo ─────────────────────────────────
  { nodeId: 50, speaker: 'narrator', text: 'Tonis Handy vibriert.', emotion: null, nextNodeId: 51 },
  { nodeId: 51, speaker: 'toni', text: 'Eine Nachricht von Neo.', emotion: 'surprised', nextNodeId: 52 },
  { nodeId: 52, speaker: 'manu', text: 'Na endlich.', emotion: 'happy', nextNodeId: 53 },
  { nodeId: 53, speaker: 'narrator', text: 'Toni öffnet die Nachricht. Liest.', emotion: null, nextNodeId: 54 },
